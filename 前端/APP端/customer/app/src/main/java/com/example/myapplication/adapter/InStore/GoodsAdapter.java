...
public class GoodsAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    ...
    public View getHeaderView(int position, View convertView, ViewGroup parent) {
        if(convertView==null) {
            convertView = mInflater.inflate(R.layout.item_header_good_view, parent, false);
        }
    ...
    class ItemViewHolder implements View.OnClickListener{
        private TextView name,price,scaleNum,tvAddFirst,tvAddNext,tvMinus,tvCount;
        private GoodsItem item;
        private RatingBar ratingBar;

        public ItemViewHolder(View itemView) {
            name = (TextView) itemView.findViewById(R.id.list_food_name);
            price = (TextView) itemView.findViewById(R.id.tvPrice);
            scaleNum=(TextView) itemView.findViewById(R.id.tvNum);
            tvCount = (TextView) itemView.findViewById(R.id.count);
            tvMinus = (TextView) itemView.findViewById(R.id.tvMinus);
            tvAddFirst = (TextView) itemView.findViewById(R.id.tv_add_first);
            tvAddNext = (TextView) itemView.findViewById(R.id.tv_add_next);
            ratingBar = (RatingBar) itemView.findViewById(R.id.ratingBar);
            tvMinus.setOnClickListener(this);
            tvAddFirst.setOnClickListener(this);
            tvAddNext.setOnClickListener(this);
        }

        public void bindData(GoodsItem item){
            this.item = item;
            name.setText(item.name);
            scaleNum.setText("月售量:"+String.valueOf(item.scaleNum));
            ...
            if(item.count<1){
                ...
                tvAddNext.setVisibility(View.GONE);
            }else{
                tvCount.setVisibility(View.VISIBLE);
                tvMinus.setVisibility(View.VISIBLE);
                tvAddFirst.setVisibility(View.GONE);
                tvAddNext.setVisibility(View.VISIBLE);
            }
        }
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.tv_add_first:
                case R.id.tv_add_next: {
